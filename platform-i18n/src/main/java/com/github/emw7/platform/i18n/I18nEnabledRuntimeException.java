 ...
 * <b>Example-A</b>
 * <pre>
 * public final class AcmeI18nException extends I18nEnabledRuntimeException {
...
public abstract class I18nEnabledRuntimeException extends RuntimeException {
   ...
   */
  public I18nEnabledRuntimeException(@NonNull final String label,
  ...
  /**
   * See {@link I18nEnabledRuntimeException#I18nEnabledRuntimeException(String, Map, Throwable, boolean, boolean)}
