package com.github.emw7.platform.log.examples.log4j2;
...
public class PlatformLogApp {
  ...
  public static void main(String[] argv) {
    ...
    // the shutdown hook for log4j2.
    Runtime.getRuntime().addShutdownHook(new Thread(() -> {
      try {
        LogEvent.terminated.await();
        LogManager.shutdown();
        System.err.printf("[%s] log4j2 log subsystem terminated%n", formatter.format(LocalDateTime.now()));
