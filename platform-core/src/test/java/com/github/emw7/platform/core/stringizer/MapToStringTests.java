...
public class MapToStringTests {
  ...
  public void givenManyEntriesWithIntegerKey_whenToStringSortedByKey_thenStringManyEntries() {
    final String s = MapToString.mapToStringSortedByKey(
        Map.of(1, false, 2, 0L, 3, "a", 4, 2.71828182845D, 5, 1, 6, "b", 7, 3.14F, 8, true));
  ...
  public void givenManyEntriesWithStringKey_whenToStringSortedByKey_thenStringManyEntries() {
    final String s = MapToString.mapToStringSortedByKey(
        Map.of("h", false, "a", 0L, "b", "a", "c", 2.71828182845D, "d", 1, "e", "b", "f", 3.14F, "g", true));
    Assertions.assertThat(s)
