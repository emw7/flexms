...
# output:
# {"uuid":"ecefe5ce-a2e4-452a-a70f-f59677d681ce","name":"resource-1","i":1}
```
...
# output:
# {"uuid":"1ea07d00-e077-4d7a-9b0f-dc3d0ae198bf","name":"","i":0}
```
...
# output: 
# {"content":[{"uuid":"0ce816ad-d984-43a7-9671-c114135695ad","name":"foo-8","i":8}],"page":{"size":20,"number":0,"totalElements":1,"totalPages":1}}
```
...
# output:
# {"uuid":"bea45f99-07e9-40bf-b5ac-793475e5afb2","name":"resource-1","i":1}
```
