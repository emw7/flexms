...
public final class PutRestProtocolRequest<B> extends AbstractRestProtocolRequest<B> {
  ...
  public static class Builder<B> extends
      AbstractRestProtocolRequest.Builder<B, PutRestProtocolRequest<B>> {
    ...
    public PutRestProtocolRequest.Builder<B> httpHeader(@NonNull final String name,
        @NonNull final String... values) {
      this.httpHeaders.addAll(name, Arrays.stream(values).toList());
      return this;
    }

    public PutRestProtocolRequest.Builder<B> acceptableMediaTypes(
    ...
    @Override
    protected PutRestProtocolRequest<B> _build() {
      return new PutRestProtocolRequest<>(httpHeaders, acceptableMediaTypes, pathParams,
  ...
  public static <B> PutRestProtocolRequest.Builder<B> builder(
      ...
      @Nullable final Map<String, Parameter<?>> expectedQueryParameters) {
    return new PutRestProtocolRequest.Builder<>(expectedPathParameters, expectedQueryParameters);
  }
  //endregion Builder

  //region Constructors
  private PutRestProtocolRequest(@NonNull final HttpHeaders httpHeaders,
